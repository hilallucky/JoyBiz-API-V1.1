    ...
    try {
      ...
      foreach ($products as $product) {
        ...
        $newProduct = [
          ...
          'is_master_product' => $product['is_master_product'] ? $product['is_master_product'] : '0',
          'is_register' => $product['is_register'],
          'status' => $status,
          'show_status' => $product['show_status'],
          'sc_show_status' => $product['sc_show_status'],
          'weight' => $product['weight'],
          'allow_from_rank' => $product['allow_from'] ? $product['allow_from'] : null,
          'allow_from_rank_id' => $product['allow_from_id'] ? $product['allow_from_id'] : null,
          'allow_to_rank' => $product['allow_to'] ? $product['allow_to'] : null,
          'allow_to_rank_id' => $product['allow_to_id'] ? $product['allow_to_id'] : null,
    ...
    try {
      ...
      foreach ($products as $productData) {
        ...
        $product->update([
          ...
          'is_master_product' => $productData['is_master_product'],
