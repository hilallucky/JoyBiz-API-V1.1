...
return new class extends Migration {
    ...
    public function up()
    {
        Schema::create('order_headers', function (Blueprint $table) {
            ...
            $table->uuid('order_headers_temp_uuid')->unique();
            $table->uuid('details_uuid')->comment('Get from table order_details');
            $table->uuid('payments_uuid')->comment('Get from table order_payments');
            $table->uuid('shipping_uuid')->comment('Get from table order_shipping');
