...
return new class extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create('products', function (Blueprint $table) {
            ...
            $table->enum('is_product_group', [0, 1])->comment('Status : 0 = Single, 1 = Group/Bundling/Package')->default(0);
            $table->enum('is_register', [0, 1])->comment('Type Product for register : 0 = Non Register Product, 1 = Regular (Non Register) Product')->default(0);
            $table->enum('status', [0, 1, 2, 3, 4])->comment('Status : 0 = Inactive, 1 = Active, 2 = Disabled, 3 = Terminated, 4 = Indent')->default(1);
