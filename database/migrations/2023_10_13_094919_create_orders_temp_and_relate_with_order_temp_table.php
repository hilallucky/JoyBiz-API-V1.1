...
return new class extends Migration
{
  ...
  public function up()
  {
    // Table order_group_headers_temp
    Schema::create('order_group_headers_temp', function (Blueprint $table) {
      $table->id();
    ...
    // Table order_group_payments_temp
    Schema::create('order_group_payments_temp', function (Blueprint $table) {
      $table->id();
      $table->uuid('uuid')->unique();
      $table->uuid('order_group_header_temp_uuid');
      ...
      $table->foreign('order_group_header_temp_uuid')->references('uuid')->on('order_group_headers_temp')->onDelete('cascade');
    ...
    Schema::create('order_payments_temp', function (Blueprint $table) {
      ...
      $table->string('voucher_code')->nullable()->comment('Voucher code reference if payment using voucher.');
      $table->decimal('amount', 10, 2)->default(0);
    ...
    Schema::create('order_statuses', function (Blueprint $table) {
      ...
      $table->enum('status', [0, 1, 2, 3, 4, 5, 6, 7])->nullable()->comment('Status : 0 = Pending, 1 = Paid, 2 = Posted, 3 = Rejected, 4 = Waiting For Prepared, 5 = Prepared From Warehouse, 6 = Picked Up By Courier, 7 = Delivered')->default(0);
  ...
  {
    Schema::dropIfExists('order_group_headers_temp');
    Schema::dropIfExists('order_group_payments_temp');
